...
export default function Chat() {
    ...
    function connect() {
        const ws = new WebSocket('ws://chat-app-front-orcin.vercel.app');
        setWs(ws);
    ...
    useEffect(() => {
        const div = div_messages.current;
        if (div){
            ...
            <div className="bg-white w-1/3 flex flex-col">
                ...
                <div className="p-2 text-center flex items-center justify-center">
                    ...
                    <button onClick={logout}
                            className="text-sm bg-blue-100 py-1 px-2 text-gray-600 border rounded-sm">logout
                    </button>
                </div>
            </div>
                    ...
                    {!!selectedUserId && (
                        <div className="relative h-full">
                            <div className="overflow-y-scroll absolute top-0 left-0 right-0 bottom-2">
                                ...
                                <div className="h-12" ref={div_messages}></div>
                            </div>
                        </div>
                    )}
                </div>
                {!!selectedUserId && (
                    <form className="flex gap-2" onSubmit={sendMessage}>
                        <input type="text"
                               ...
                               className="bg-white flex-grow border rounded-l p-2"/>
                        <label className="bg-blue-200 p-2 rounded-l text-gray-600 cursor-pointer border border-blue-200">
                        ...
                        <button type="submit" className="bg-blue-500 p-2 rounded-l text-white">
